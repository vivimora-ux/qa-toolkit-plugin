...
available, over a narrative walk-through.

When using the pr-review skill instead, lead with **scope of impact**:
which files, components, or services the change touches, and what part
of the application that represents, before covering anything else.

This stays in effect until `/trace` or `/risk` is used instead.
